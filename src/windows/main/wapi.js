    ...
    window.WAPI.sendVideoAsGif = function (
        ...
        return Store.Chat.find(idUser).then(chat => {
            ...
            mc.processFiles([mediaBlob], chat, 1).then(() => {
                ...
                media.mediaPrep.sendToChat(chat, {
                    caption: caption
                });
                if (done !== undefined) done(true);
            });
